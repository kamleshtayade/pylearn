"""Minimal retry example for a LangGraph workflow of error handling and resilience.

Shows a single node that can fail and is retried up to 3 times using
conditional edges. Requirements: langgraph.
"""
...
##  python ./aai/ch3/02-retry-tool.py