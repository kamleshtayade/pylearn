...
docs = ["LangChain enables modular AI agents.",
        "FAISS stores embeddings for local retrieval.","FAISS is a library for efficient similarity search and clustering of dense vectors."]
...
# python ./aai/ch6/01-faiss-demo.py